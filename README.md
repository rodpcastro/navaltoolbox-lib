...
- **Multi-hull support**: Catamarans, trimarans, arbitrary configurations with contact surface detection
...
- **Deck Edges**: Define deck edge polygons (livet) for freeboard calculation and deck immersion point detection
